...
- **Reorder groups** — drag a group's chip to move the whole group along the bar as one block. Drop it anywhere on another group (its chip or any of its tabs) and it lands before or after that group as a unit — groups reorder *around* each other and never split or merge. Aim at the left half to land before, the right half to land after; the left half of a group's chip is how you reach the very start of the bar.
